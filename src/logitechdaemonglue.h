...
#ifndef __dbus_glib_marshal_logitechdaemon_MARSHAL_H__
#define __dbus_glib_marshal_logitechdaemon_MARSHAL_H__
...
void
dbus_glib_marshal_logitechdaemon_BOOLEAN__DOUBLE_POINTER (GClosure     *closure,
...
#endif /* __dbus_glib_marshal_logitechdaemon_MARSHAL_H__ */

#include <dbus/dbus-glib.h>
static const DBusGMethodInfo dbus_glib_logitechdaemon_methods[] = {
  { (GCallback) logitechdaemon_set_kb_brightness, dbus_glib_marshal_logitechdaemon_BOOLEAN__DOUBLE_POINTER, 0 },
};

const DBusGObjectInfo dbus_glib_logitechdaemon_object_info = {
  0,
